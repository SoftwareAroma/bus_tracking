...
abstract class $EventModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? title, String? description, String? time});
}
...
class _$_EventModel implements _EventModel {
  const _$_EventModel({this.id, this.title, this.description, this.time});
  ...
  @override
  String toString() {
    return 'EventModel(id: $id, title: $title, description: $description, time: $time)';
  }
...
abstract class _EventModel implements EventModel {
  const factory _EventModel(
      ...
      final String? title,
      final String? description,
      final String? time}) = _$_EventModel;
